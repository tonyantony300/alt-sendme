...
2. شارك التذكرة عبر الدردشة أو البريد الإلكتروني أو الرسائل النصية، **أو** أرسل مباشرة إلى جهاز مقترن (سطح المكتب / Android).
3. يلصق صديقك التذكرة في تطبيقه (أو يقبل دعوة جهاز مقترن)، ويبدأ النقل.

### الأجهزة المقترنة

على macOS وWindows وLinux وAndroid يمكنك اقتران الأجهزة في **الإعدادات → الأجهزة** باستخدام رمز اقتران. بعد الاقتران:

- يمكن للمرسلين النقر على **Send** بجانب جهاز مقترن أثناء المشاركة: دون نسخ التذكرة يدويًا.
- يتلقى المستقبلون مطالبة داخل التطبيق عندما يدعوهم مرسل مقترن (يجب أن يكون التطبيق مفتوحًا).
