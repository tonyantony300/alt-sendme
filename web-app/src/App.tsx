...
function AppContent() {
	...
	return (
		<div
			className="h-screen flex flex-col relative glass-background select-none"
		...
		>
			...
			<div className="container mx-auto p-8 flex-1 overflow-auto">
				<div className="max-w-2xl mx-auto">
					...
					<div className="rounded-lg shadow-sm glass-card overflow-hidden">
						{activeTab === 'send' ? (
							<motion.div
								key="send"
								initial={
									isInitialRender.current ? { opacity: 0, x: -20 } : false
								}
