...
export interface TauriCommands {
	start_sharing: (path: string, description?: string) => Promise<string>
...
export const tauriCommands: TauriCommands = {
	start_sharing: (path: string, description?: string) =>
		invoke('start_sharing', { path, description: description || null }),
